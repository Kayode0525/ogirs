        ...
        $("#kt_dropzone_1").dropzone({
            ...
            function () {
                ...
                t.on("addedfile", (function (o) {
                    ...
                    }, document.querySelector(e + " .dropzone-remove-all")
                    .onclick = function () {
                        $(e + " .dropzone-upload, " + e + " .dropzone-remove-all").
                        css("display", "none"), t.removeAllFiles(!0)
                    }, t.on("queuecomplete", (function (o) {
                        $(e + " .dropzone-upload")
                            .css("display", "none")
                    })), t.on("removedfile", (function (o) {
                        t.files.length < 1 && $(e + " .dropzone-upload, " + e + " .dropzone-remove-all")
                            .css("display", "none")
                    }))
            }(),
            function () {
                ...
                t.on("addedfile", (function (o) {
                    $(document)
                        .find(e + " .dropzone-item").css("display", "")
                })), t.on("totaluploadprogress", (function (o) {
