...
<body style="margin: 0; font: 12px/ 16px Arial, sans-serif"><img width="1" height="1"
        src="images/b103aa629cacdd90b39538a7561da7f8e49ad73f.gif" />
    <table id="container" cellpadding="0"
        style="width: 640px; color: rgb(51, 51, 51); margin: 0 auto; border-collapse: collapse">
        <tbody>
            <tr>
                <td class="frame"
                    style="padding: 0 20px 20px 20px; vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                    <table id="main" cellpadding="0" style="width: 100%; border-collapse: collapse">
                        <tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td rowspan="2" class="logo"
                                                    style="width: 115px; padding: 20px 20px 0 0; vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                                                    <img alt="Funaab Logo"
                                                        src="{{ asset('assets/media/demos/demo4/funaablogo1.png') }}"
                                                        height="90" width="120" style="border: 0">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="title"
                                                    style="text-align: right; padding: 7px 0 5px 0; vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                                                    <h2
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <span class="heading">
                                                        <h3
                                                            style="font-size: 18px; color: #4CAF50; margin: 15px 0 0 0; font-weight: normal">
                                                            Dear {{ $username }},
                                                        </h3>
                                                    </span>
                                                    <br />
                                                    <p style="margin: 1px 0 8px 0; font: 12px/ 16px Arial, sans-serif">
                                                       Thank you for submitting your annual returns and income tax form.We shall get back in touch with you if your submission is successfull. <b>for
                            ...
                            <tr>
                                <td
                                    style="vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                                    <table id="division" style="border-collapse: collapse">
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                            ...
                            <tr>
                                <td
                                    style="vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                                    <table id="closing" cellpadding="0"
                                        style="width: 100%; padding: 0 0 0 0; border-collapse: none">
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                                                    <br />
                                                    <p
                                                        style="padding: 0 0 20px 0; border-bottom: 1px solid rgb(234, 234, 234); margin: 0; font: 12px/ 16px Arial, sans-serif">
                                                        <br />Cheers,<br />
                                                        <span class="signature"
                                                            style="font-size: 16px; font-weight: bold">
                                                            Ogun State Internal Revenue Service Team.
                                                        </span>
                                                    </p>
                                                    <br />


                                                    <br /> Need help? <a href="#">Contact us</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="vertical-align: top; font-size: 13px; line-height: 18px; font-family: Arial, sans-serif">
                                                    <p
                                                        style="font-size: 10px; color: rgb(102, 102, 102); line-height: 16px; margin: 0 0 10px 0; font: 10px">
                                                        This email was sent from a notification-only email address that
                                                        cannot accept incoming email. Please do not reply to this
                                                        message. OGIRS orders are subject to the <a href="#"
                                                            style="font-size: 10px; font: 10px; text-decoration: none; color: rgb(0, 102, 153)">FUNAAB
                                                            Conditions of Use</a>.
