...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/custom/apps/profile/profile-1/overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Dec 2020 06:11:46 GMT -->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Welcome , XYZ Company Nig.Ltd.</h2>
										<!--end::Title-->
												...
												<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
													...
													<div class="navi-item mb-2">
														<a href="{{route('monthly_returns_home')}}" class="navi-link py-4">
															...
															<span class="navi-text font-size-lg">Monthly Returns</span>
														</a>
													</div>
													<div class="navi-item mb-2">
