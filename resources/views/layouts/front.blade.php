			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						<!--begin::Subheader-->
						<div class="subheader py-1 py-lg-9 subheader-transparent" id="kt_subheader">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container" >
								...
								<div class="pad-all text-center" style="color: white;">
										<h3>Ogun State Internal Revenue Service Portal.</h3>
										<p1>Simplifying the process of Paying Your Tax</p>
									</div>
								</div>
...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/custom/apps/projects/list-columns-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Dec 2020 06:12:09 GMT -->
</html>