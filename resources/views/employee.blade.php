				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						...
						<div class="overlay-layer">
							<a href="basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo3/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo3/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo4/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo4/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo5/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo5/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo6/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo6/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo7/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo7/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo8/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo8/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo9/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo9/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo10/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo10/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo11/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo11/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo12/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo12/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo13/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo13/rtl/crud/datatables/basic/basic.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
		...
		function performDelete(el,user_id)
			{
				try {
						...
						function (data, status) {
							...
							console.table(data);
							if( status === "success") {
								let alert = swal("Deleted successfully !.");
