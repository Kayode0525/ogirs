...
<head>
		...
		<meta charset="utf-8" />
		<title>Ogirs Portal-Invoice</title>
		...
		<link href="{{ asset('frontend/assets/css/style.bundled11cf.css?v=7.1.6')}}" rel="stylesheet" type="text/css" />
								...
								<div class="dropdown">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
											...
											<span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">{{Session::get("company_name")}}</span>
											...
											<div class="col-md-9">
												<div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
													...
													<div class="d-flex flex-column align-items-md-end px-0">
														<!--begin::Logo-->
														<a href="#" class="mb-5">
															<!-- <img src="{{ asset('frontend/assets/media/logos/logo-dark.png')}}" alt="" /> -->
														</a>
														<!--end::Logo-->
														<span class="d-flex flex-column align-items-md-end opacity-70">
															<span>Ogun State Internal Revenue Services</span>
												...
												<div class="d-flex justify-content-between pt-6">
													...
													<div class="d-flex flex-column flex-root">
														...
														<span class="opacity-70">{{ Session::get("company_name") }}, {{Session::get("company_email")}}
														<br />{{Session::get("company_phone")}}</span>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-md-9">
												<div class="table-responsive">
													<table class="table">
														<thead>
															<tr>
																<th class="pl-0 font-weight-bold text-muted text-uppercase">Staff ID</th>
														...
														@foreach($records as $record)
															<tr class="font-weight-boldest">
																<td class="pl-0 pt-7">{{$record->staff_id }}</td>
																<td class="pl-0 pt-7">{{$record->firstname }}</td>
																<td class="text-right pt-7">{{$record->total_tax_deducted }}</td>
													...
													<table class="table">
														...
														<tbody>
															<tr class="font-weight-bolder">
																...
																<td>12345678909</td>
																<td>Jan 07, 2018</td>
																<td class="text-danger font-size-h3 font-weight-boldest">{{number_format($invoice_sum,2)}}</td>
															</tr>
														</tbody>
													</table>
												</div>
										...
										<div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
											<div class="col-md-9">
												<div class="d-flex justify-content-between">
													...
													<a href="{{ route('pay') }}" class="btn btn-primary font-weight-bold" >Make Payment</a>
						...
						<div class="navi mt-2">
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{Session::get("company_email")}}</span>
								</span>
							</a>
